...
set seating_type = 'ga'
where event_id = 'bbbbbbbb-0000-4000-8000-000000000001';
...
values
  ('eeeeeeee-0000-4000-8000-000000000001', 'dddddddd-0000-4000-8000-000000000001', 'VIP STANDING', 4500, 200, 8, 'ga',      null, null),
  ('eeeeeeee-0000-4000-8000-000000000002', 'dddddddd-0000-4000-8000-000000000001', 'ZONE A',       3500,  70, 8, 'seated',    5,   14),
  ('eeeeeeee-0000-4000-8000-000000000003', 'dddddddd-0000-4000-8000-000000000001', 'ZONE B',       2500,  96, 8, 'seated',    6,   16),
  ('eeeeeeee-0000-4000-8000-000000000004', 'dddddddd-0000-4000-8000-000000000001', 'ZONE C',       1800, 108, 8, 'seated',    6,   18),
  ('eeeeeeee-0000-4000-8000-000000000005', 'dddddddd-0000-4000-8000-000000000001', 'ZONE D',       1500, 126, 8, 'seated',    7,   18)
on conflict (id) do nothing;

-- ---- สร้างเก้าอี้ให้โซนที่นั่ง (idempotent: generate_seats ใช้ on conflict do nothing) ----
select public.generate_seats('eeeeeeee-0000-4000-8000-000000000002');
select public.generate_seats('eeeeeeee-0000-4000-8000-000000000003');
select public.generate_seats('eeeeeeee-0000-4000-8000-000000000004');
select public.generate_seats('eeeeeeee-0000-4000-8000-000000000005');
